class ExameRequisicoesController < ApplicationController
  ...
  def new
    redirect_to root_url(subdomain: @lab.organizacao.subdomain), alert: "Enquanto não houver tipos de exames cadastrados nesse laboratório não será possível solicitar novos exames." if @lab.exame_tipos.empty?
